...
app.get('/api/health', (req, res) => {
  ...
  res.json({
    ...
    translation: (process.env.GROQ_API_KEY || process.env.GEMINI_API_KEY) ? 'llm (active)' : 'unavailable',
    local_voice: process.env.MMS_TTS_URL ? 'mms-tts (backend)' : 'web-speech (navigateur)',
