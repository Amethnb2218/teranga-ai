...
const LANGUAGES = {
  ...
  wo:  { label: 'Wolof',    tier: 'full', region: 'Sénégal',                 nllb: 'wol_Latn', whisper: null, mmsAsr: 'wol', mmsTts: null,  speechLang: 'fr-FR' },
  pu:  { label: 'Pulaar',   tier: 'full', region: 'Sahel (SN→Tchad)',        nllb: 'fuv_Latn', whisper: null, mmsAsr: 'ful', mmsTts: 'ful', speechLang: 'fr-FR' },
  ...
  kr:  { label: 'Kanouri',  tier: 'full', region: 'Niger/Tchad/Nigéria',     nllb: 'knc_Latn', whisper: null, mmsAsr: 'knc', mmsTts: null,  speechLang: 'fr-FR' },
  tmh: { label: 'Tamasheq', tier: 'full', region: 'Mali/Niger',             nllb: 'taq_Latn', whisper: null, mmsAsr: 'taq', mmsTts: 'taq', speechLang: 'fr-FR' },

  // --- BETA : pas de traduction NLLB fiable (sortie française) ---
  // NB (vérifié) : Sérère et Soninké n'ont AUCUN modèle TTS (nulle part) ->
  // voix uniquement via Web Speech du navigateur. Diola/Mandinka ont un MMS.
  sr:  { label: 'Sérère',   tier: 'beta', region: 'Sénégal',                 nllb: null, whisper: null, mmsAsr: null,  mmsTts: null,  speechLang: 'fr-FR' },
  ...
  sn:  { label: 'Soninké',  tier: 'beta', region: 'Mali/Sénégal/Mauritanie', nllb: null, whisper: null, mmsAsr: null,  mmsTts: null,  speechLang: 'fr-FR' }
};
